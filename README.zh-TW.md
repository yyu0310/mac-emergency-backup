...
MacBook 進水了。M3 MacBook Air 的 SSD 焊死在主機板且硬體加密，**資料只能靠原機開機取出**，沒辦法拆硬碟外接。

用 Claude Code 寫了這份緊急備份工具包，透過手機的 Claude app 遠端操控進水的筆電，不到 10 分鐘所有重要資料都進了外接硬碟。
...
| 優先順序 | 項目 |
|---|---|
| 最高 | VS Code Workspace 資料夾（你的主要專案目錄）|
