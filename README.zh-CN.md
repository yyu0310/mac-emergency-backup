...
- **一键备份脚本** (`backup.sh`)：涵盖项目文件夹、Claude Code 配置、SSH 密钥、dotfile、开发者凭证、VS Code 配置、launchd agents、Documents/Desktop/Downloads
...
- macOS（在 M3 MacBook Air 上测试）
- 外接硬盘（exFAT 格式即可，Thunderbolt 4 速度较快）
- Claude Code 已安装（方案 A 才需要）

---

## 注意事项

- 脚本使用 macOS 路径，**不支持 Linux 或 Windows**
