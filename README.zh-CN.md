...
天气预报说傍晚降雨率 30%，放松警惕出门，从百货停车场出来直接遇到暴雨，背包套了防雨套还是全湿，MacBook 泡水，屏幕出现块状色斑，机壳缝隙持续流水。

M3 MacBook Air 的 SSD 焊死在主板且硬件加密，**资料只能靠原机开机取出**，没办法拆硬盘外接。上一次备份已经是 3 个月前，里面有所有的 AI 配置、自定义 Skill、程序项目、工作日志。

决定赌一把：用 Claude Code 写了这份紧急备份工具包，接着开机，全程通过手机的 Claude app 远程操控进水的笔电执行备份，不到 10 分钟所有重要资料都进了外接硬盘。
